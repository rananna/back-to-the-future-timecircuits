...
* **Preset Time Jumps**: The web UI comes pre-loaded with famous dates from the movies. You can also add, edit, and delete your own custom date presets, which are saved on the device's flash memory.
