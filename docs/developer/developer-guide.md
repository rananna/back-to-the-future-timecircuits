...
| `Test Suite` | **(Diagnostic Tool)** A non-visual sequence that runs a series of tests on core firmware functions (display, sound, MQTT, etc.) and displays "TESTS: PASS" on completion. |
