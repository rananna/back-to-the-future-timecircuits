...
void runBootSequence() {
  ...
  if (ENABLE_HARDWARE) {
    destRow.month.print("REC");
    destRow.month.writeDisplay();
    destRow.day.print("AL");
    destRow.day.writeDisplay();
    destRow.year.print("IBRA");
    destRow.year.writeDisplay();
    destRow.time.print("TING");
  ...
  if (ENABLE_HARDWARE) {
    ...
    presRow.year.print("SELF");
    presRow.year.writeDisplay();
    presRow.time.print("TEST");
  ...
  if (ENABLE_HARDWARE) {
    lastRow.month.print("CAP");
    lastRow.month.writeDisplay();
    lastRow.day.print("AC");
    lastRow.day.writeDisplay();
    lastRow.year.print("ITOR");
    lastRow.year.writeDisplay();
    lastRow.time.print("FULL");
