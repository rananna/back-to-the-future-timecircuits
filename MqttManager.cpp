...
void handleSequencerCommand(const std::string& payload) {
    ...
    if (error != DeserializationError::Ok) {
        ...
        if (payload == "Intruder Alert") {
            ...
            json_to_parse = R"([{"targetRow":0, "commands":[{"command":"RANDOM_FLICKER_TEXT", "intParam":10000, "intParam2":50}]}, {"targetRow":1, "commands":[{"command":"RANDOM_FLICKER_TEXT", "intParam":10000, "intParam2":50}]}, {"targetRow":2, "commands":[{"command":"RANDOM_FLICKER_TEXT", "intParam":10000, "intParam2":50}]}])";
